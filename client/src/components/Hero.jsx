      ...
      <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
        ...
        <div className='border border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex'>
          <div className='flex justify-center gap-10 lg:gap-14 flex-wrap'>
            ...
            <img className='h-6 ' src={assets.tcs_logo} alt="tcs" />
            <img className='h-6 ' src={assets.creast_logo} alt="creast" />
            <img className='h-6 ' src={assets.walmart_logo} alt="walmart className='h-6 '" />
          </div>
        </div>
